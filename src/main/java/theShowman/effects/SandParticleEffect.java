...
public class SandParticleEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float destY;
    ...
    public SandParticleEffect(float x, float y, float fAngle, boolean shouldFlip) {
        ...
        this.color = new Color(0.79F, 0.74F, 0.44F, 0.0F);
        this.color.a = 0.0F;
    }
    ...
    public void update() {
        ...
        this.x += derp.x * Gdx.graphics.getDeltaTime() * 3500.0F * Settings.scale;
        this.y += derp.y * Gdx.graphics.getDeltaTime() * 3500.0F * Settings.scale;
