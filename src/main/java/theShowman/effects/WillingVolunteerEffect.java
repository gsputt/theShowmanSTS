...
public class WillingVolunteerEffect extends AbstractGameEffect {
    ...
    public WillingVolunteerEffect(AbstractMonster m)
    {
        this.m = m;
    ...
    public void update()
    {
        ...
        if(this.graphicsAnimation >= 0.5F && this.graphicsAnimation <= 1.0F)
        {
            m.drawY = drawYStartMonster + Interpolation.exp10Out.apply(drawYStartMonster, drawYStartMonster + 200F * Settings.scale, (graphicsAnimation - 0.5F) / 0.5F) - Interpolation.linear.apply(drawYStartMonster, drawYStartMonster + 200F * Settings.scale, (graphicsAnimation - 0.5F) / 0.5F);
        }
        if(this.graphicsAnimation >= 1.0F && graphicsAnimation <= 1.5F)
        {
            m.drawY = drawYStartMonster + Interpolation.exp10Out.apply(drawYStartMonster, drawYStartMonster + 200F * Settings.scale, (graphicsAnimation - 1.0F) / 0.5F) - Interpolation.linear.apply(drawYStartMonster, drawYStartMonster + 200F * Settings.scale, (graphicsAnimation - 1.0F) / 0.5F);
        }
