package theShowman.cards.Default;
...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = ShowmanMod.makeID(DefaultCommonAttack.class.getSimpleName());
    ...
    // The list of all of them can be found in the main ShowmanMod.java file in the
    ...
    public static final CardColor COLOR = TheShowman.Enums.COLOR_PURPLE;
    ...
    // Go check out DefaultAttackWithVariable and theShowman.variable.DefaultCustomVariable
