package theShowman.variables;

import basemod.abstracts.DynamicVariable;
import com.megacrit.cardcrawl.cards.AbstractCard;
import theShowman.cards.AbstractDefaultCard;

import static theShowman.ShowmanMod.makeID;
...
public class DefaultSecondMagicNumber extends DynamicVariable {
    ...
    public String key() {
        ...
        // Remember, we're using makeID so it automatically puts "theShowman:" (or, your id) before the name.
    }
