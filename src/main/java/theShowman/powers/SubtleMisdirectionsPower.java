...
public class SubtleMisdirectionsPower extends AbstractPower implements CloneablePowerInterface, OnCardDrawPower {
    ...
    public SubtleMisdirectionsPower(final AbstractCreature owner, final int amount, final boolean upgraded) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
    ...
    public AbstractPower makeCopy() {
        return new SubtleMisdirectionsPower(owner, amount, this.upgraded);
    }
}
